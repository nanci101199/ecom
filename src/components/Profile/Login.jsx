...
function Login() {
 ...
 const navigate = useNavigate()
  ...
  const loginwithemail = async () => {
    // https://admin.nily.com.br/api/v2/login-with-password
    let _formdata = new FormData();
    _formdata.append('email', emaillogin.email)
    ...
    .then((response) => {
        ...
        navigate('/home', {state:access_tokens})
  ...
  return (
    <>
      <div className='' style={{ backgroundImage: 'url(https://t3.ftcdn.net/jpg/03/55/60/70/360_F_355607062_zYMS8jaz4SfoykpWz5oViRVKL32IabTP.jpg)' }}>
        ...
        <div className='row my-5'>
          <div className='col-8 m-auto'>
            <div className="row m-0  justify-content-center" >
              <div className="col-lg-6 col-md-8 col-12 mt-5 mb-5">
                <div className='fs-3 fw-bold text-center'>Sign In</div>
                <div className="form-area">
                  <div className="form-inner text-center m-auto">
                    <ul className="react-tab-link-group m-auto">
                      <li className={`${active === 0 ? 'active' : ''}`}><a className="react-tab-link" onClick={tabClick} id="0">Phone</a></li>
                      <li className={`${active === 1 ? 'active' : ''}`}><a className="react-tab-link" onClick={tabClick} id="1">Email</a></li>
                    </ul>
        ...
        :<div className='p-5 mx-5 text-center h-100'>

          <h1>LogOut? </h1>
          <div >
            Want to login with another Account? <button className='btn btn-secondary' onClick={relogin} > Click me </button>
          </div>
